DIR_hz2phone = 'D:\TestCode\hclg_testcode\hz2phone.txt'
DIR_corpus_class = 'D:\TestCode\hclg_testcode\corpus_class_based.txt'
DIR_dict = "D:\TestCode\hclg_testcode\dict_py.txt"
with open (DIR_hz2phone,'r',encoding='utf-8') as f1 , open (DIR_corpus_class,'r',encoding='utf-8') as f2:
...
with open(DIR_dict,"a+",encoding='utf-8') as f3: 
    for item in ci_list:
        ci2phone_list = []
        for x in item:
